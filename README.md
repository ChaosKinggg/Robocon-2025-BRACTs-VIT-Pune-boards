...
- [**STM32F407-DISC Buffer Board RC-25**](./STM32F407-DISC%20Buffer%20Board%20RC-25): Interface and buffering board for STM32F407 Discovery based control systems.
- [**ESP32 Server-Client Buffer Board RC-25**](./ESP32%20Server-Client%20Buffer%20Board%20RC-25): Communication buffer board for reliable ESP32-based server–client interaction.
...
- [**Power Switch Board RC-25**](./Power%20Switch%20Board%20RC-25): High-Power distribution and controlled switching board for robot subsystems.
- [**Logic Switch Board RC-25**](./Logic%20Switch%20Board%20RC-25): Low-Power distribution and controlled switching board for robot subsystems.
...
- **Deployed Build** – Images of actual boards used at Robocon 2025  
...
- **The Robotics Forum (TRF)**:  
  The official robotics club of the institute where this development was undertaken.
  
- **BRACT’s Vishwakarma Institute of Technology, Pune**:  
  For providing the platform, infrastructure, and institutional support to participate in Robocon 2025.

- **Altium Designer**:  
  For providing a powerful and professional PCB design environment used for all hardware development.
